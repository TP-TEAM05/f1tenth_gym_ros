...
7. In your browser, navigate to [http://localhost:8000/vnc.html](http://localhost:8000/vnc.html), you should see the noVNC logo with the connect button. Click the connect button to connect to the session.
